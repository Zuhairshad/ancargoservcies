...
// Marks the document as scripted as early as possible so CSS can enable
// JS-only features (transitions, reveals). The is-visible class is applied
// by Reveal.tsx via useLayoutEffect to avoid SSR hydration mismatches.
const revealAboveFold = `(function(){try{document.documentElement.classList.add('js')}catch(e){}})();`
